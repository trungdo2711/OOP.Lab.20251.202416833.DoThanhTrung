...
public class Aims2 {
        ...
        while(!back){
            ...
            switch(option){
                ...
                case 3:
                    ...
                    if (mediaToPlay != null){
                        if (mediaToPlay instanceof CompactDisc || mediaToPlay instanceof DigitalVideoDisc2){
                            mediaToPlay.play();
                        }
                        else{
    ...
    public static void mediaDetailsMenu(Scanner scanner, Media media) {
        ...
        while (!back){
            ...
            System.out.println("2. Play " + (media instanceof CompactDisc || media instanceof DigitalVideoDisc2 ? "(Available)" : "(Not available)"));
            System.out.println("0. Back");
            System.out.println("--------------------------------");
            ...
            switch(option){
                ...
                case 1:
                    ...
                    break;
                case 2:
                    if (media instanceof CompactDisc || media instanceof DigitalVideoDisc2){
                        media.play();
                    }
                    else{
        ...
        while (!back) {
            ...
            switch (option) {
                ...
                case 4:
                    ...
                    String titleToPlay = scanner.nextLine();
                    if (!titleToPlay.equals("0")) {
                        Media mediaToPlay = cart.searchToRemove(titleToPlay);
                        if (mediaToPlay == null) {
                            System.out.println("Media not in the cart.");
                        } else if (mediaToPlay instanceof CompactDisc || mediaToPlay instanceof DigitalVideoDisc2) {
                            mediaToPlay.play();
